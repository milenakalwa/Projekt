...
Funkcje aplikacji:
- Obliczanie wskaźnika BMI na podstawie wagi i wzrostu użytkownika.
- Kategoryzacja wyniku BMI (np. niedowaga, nadwaga, otyłość).
- Kolorowa wizualizacja kategorii BMI za pomocą panelu.
- Ostrzeżenie i link edukacyjny dla wysokiego BMI.
- Resetowanie całego formularza jednym kliknięciem.
- Sprawdzenie, czy BMI mieści się w zalecanym zakresie w zależności od wieku.
- Wyświetlanie animacji balonów przy prawidłowym BMI.
